    ...
    <v-expansion-panel>
      ...
      <v-expansion-panel-text eager>
        <client-only>
          ...
          <teleport to="#cmd-win">
            <v-btn icon="mdi-content-copy" variant="text" @click="copyCmdLine(cmdlineWin)" />
          </teleport>
        </client-only>
      </v-expansion-panel-text>
    </v-expansion-panel>
      ...
      <v-expansion-panel-text eager>
        <client-only>
          ...
          <teleport to="#cmd-macos-1">
            <v-btn icon="mdi-content-copy" variant="text" @click="copyCmdLine(cmdlineMacos1)" />
          </teleport>
          <teleport to="#cmd-macos-2">
            <v-btn icon="mdi-content-copy" variant="text" @click="copyCmdLine(cmdlineMacos2)" />
          </teleport>
        </client-only>
      </v-expansion-panel-text>
    </v-expansion-panel>
