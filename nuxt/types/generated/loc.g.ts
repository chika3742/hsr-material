export type Loc =
  ...
  | "relicSetTitles.band-of-sizzling-thunder"
  | "relicSetTitles.hunter-of-glacial-forest"
  | "relicSetTitles.wastelander-of-banditry-desert"
  | "relicSetTitles.musketeer-of-wild-wheat"
  | "relicSetTitles.inert-salsotto"
  | "relicSetTitles.fleet-of-the-ageless"
  | "relicSetTitles.knight-of-purity-palace"
  | "relicSetTitles.talia-kingdom-of-banditry"
  | "relicSetTitles.sprightly-vonwacq"
  | "relicSetTitles.firesmith-of-lava-forging"
  | "relicSetTitles.passerby-of-wandering-cloud"
  | "relicSetTitles.thief-of-shooting-meteor"
  | "relicSetTitles.pan-galactic-commercial-enterprise"
  | "relicSetTitles.eagle-of-twilight-line"
  | "relicSetTitles.genius-of-brilliant-stars"
  | "relicSetTitles.champion-of-streetwise-boxing"
  | "relicSetTitles.belobog-of-the-architects"
  | "relicSetTitles.space-sealing-station"
  | "relicSetTitles.celestial-differentiator"
  | "relicSetTitles.guard-of-wuthering-snow"
  | "relicSetEffects.passerby-of-wandering-cloud.2pc"
  | "relicSetEffects.passerby-of-wandering-cloud.4pc"
  | "relicSetEffects.musketeer-of-wild-wheat.2pc"
  | "relicSetEffects.musketeer-of-wild-wheat.4pc"
  | "relicSetEffects.knight-of-purity-palace.2pc"
  | "relicSetEffects.knight-of-purity-palace.4pc"
  | "relicSetEffects.hunter-of-glacial-forest.2pc"
  | "relicSetEffects.hunter-of-glacial-forest.4pc"
  | "relicSetEffects.champion-of-streetwise-boxing.2pc"
  | "relicSetEffects.champion-of-streetwise-boxing.4pc"
  | "relicSetEffects.guard-of-wuthering-snow.2pc"
  | "relicSetEffects.guard-of-wuthering-snow.4pc"
  | "relicSetEffects.firesmith-of-lava-forging.2pc"
  | "relicSetEffects.firesmith-of-lava-forging.4pc"
  | "relicSetEffects.genius-of-brilliant-stars.2pc"
  | "relicSetEffects.genius-of-brilliant-stars.4pc"
  | "relicSetEffects.band-of-sizzling-thunder.2pc"
  | "relicSetEffects.band-of-sizzling-thunder.4pc"
  | "relicSetEffects.eagle-of-twilight-line.2pc"
  | "relicSetEffects.eagle-of-twilight-line.4pc"
  | "relicSetEffects.thief-of-shooting-meteor.2pc"
  | "relicSetEffects.thief-of-shooting-meteor.4pc"
  | "relicSetEffects.wastelander-of-banditry-desert.2pc"
  | "relicSetEffects.wastelander-of-banditry-desert.4pc"
  | "relicSetEffects.space-sealing-station.2pc"
  | "relicSetEffects.fleet-of-the-ageless.2pc"
  | "relicSetEffects.pan-galactic-commercial-enterprise.2pc"
  | "relicSetEffects.belobog-of-the-architects.2pc"
  | "relicSetEffects.celestial-differentiator.2pc"
  | "relicSetEffects.inert-salsotto.2pc"
  | "relicSetEffects.talia-kingdom-of-banditry.2pc"
  | "relicSetEffects.sprightly-vonwacq.2pc"
  | string
