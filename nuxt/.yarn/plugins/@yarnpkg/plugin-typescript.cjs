  ...
  factory: function (require) {
    var plugin = (() => {
      var Ft = Object.create, H = Object.defineProperty, Bt = Object.defineProperties,
        Kt = Object.getOwnPropertyDescriptor, zt = Object.getOwnPropertyDescriptors, Gt = Object.getOwnPropertyNames,
        Q = Object.getOwnPropertySymbols, $t = Object.getPrototypeOf, ne = Object.prototype.hasOwnProperty,
      ...
      var Ze = I(A => {
        ...
        function Qe(e, t, r, s) {
          let n = [], a = $e(r, s), o = Le(e, s), d = r.method,
            ...
            b = u(u(u({"x-algolia-agent": e.userAgent.value}, e.queryParameters), y), s.queryParameters), f = 0,
            p = (h, S) => {
              let O = h.pop();
      ...
      var jt = I(i => {
        ...
        var Dr = e => {
          let t = e.appId, r = l.createAuth(e.authMode !== void 0 ? e.authMode : l.AuthMode.WithinHeaders, t, e.apiKey),
        ...
        var Rr = e => (t, r) => {
          ...
          yt = e => (t, r) => {
            ...
            let O = r || {}, {safe: s, autoGenerateObjectIDIfNotExist: n, batchSize: a} = O,
              ...
              b = `${e.indexName}_tmp_${y}`, f = he({appId: e.appId, transporter: e.transporter, indexName: b}), p = [],
          ...
          js = e => (t, r) => l.createWaitablePromise(he(e)([t], r).then(s => ({
            ...
            let o = r || {}, {autoGenerateObjectIDIfNotExist: s} = o, n = R(o, ["autoGenerateObjectIDIfNotExist"]),
      ...
      var se = C(require("@yarnpkg/core")), Nt = C(Ut()), Cs = "e8e1bd300d860104bb8c58453ffa1eb4", Us = "OFCNCOG2CU",
        Wt = async (e, t) => {
          var a;
