              ...
              <v-row no-gutters>
                ...
                <div>
                  ...
                  <v-list v-model:selected="filter.path">
                    <v-list-item v-for="path in paths" :key="path" :title="tx(`paths.${path}` as const)" :value="path">
                      <template #prepend>
                        <v-img
                          class="mr-2"
                ...
                <div>
                  ...
                  <v-list v-model:selected="filter.combatType">
                    <v-list-item v-for="type in combatTypes" :key="type" :title="tx(`combatTypes.${type}` as const)" :value="type">
                      <template #prepend>
